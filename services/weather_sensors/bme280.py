...
class Bme280:
    ...
    def setup(self):
        ...
        self.bus.write_byte_data(self.addr, 0xF2, ctrl_hum_reg)
        self.bus.write_byte_data(self.addr, 0xF4, ctrl_meas_reg)
        self.bus.write_byte_data(self.addr, 0xF5, config_reg)
    ...
    def read(self):
        ...
        t_fine, temp = self.compensate_temperature(temp_raw)
        pres = self.compensate_pressure(pres_raw, t_fine)
        hum = self.compensate_pressure(hum_raw, t_fine)

        return hum, temp, pres
